...
class save_statement_to_output_folder:
    ...
    def send_statement(self,statement_file, sheet_name, file_name, folder_name):
        ...
        print(os.path.join(directory_path+folder_name, file_name))
