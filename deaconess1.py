...
class deaconess:
    def Deaconess(self,df,inf, writer):
        try:
            ...
            # print(df2[df2['Med-1 Balance'].isna()].to_string())
            # print(df1.to_string())
            ...
            print(df2[df2['Match?']=='False'].head(10).to_string())
            ...
            print('hi')
            inf3[['FACS #','Client ID','First Name','Last Name','Disposition','Phase','List Date','Med-1 Balance','Amount Cancelled','Payment Date','Cancel Code','Last Payment Date','Days in Dispo','Cancel Date','PMT TO PRN']]=np.nan
            ...
            index_13=df13[(df13['Recon file (EPIC) balance'].isna())].index

            # df13.drop(index_13,inplace=True)
            df13.drop('level_0',axis=1,inplace=True)
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/EPC_RECON_112321_48558.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df_facs1 = pd.read_csv("/home/ajay/Downloads/EnableFiles/Deaconess/Outgoing/EPC_RECON_112321_48558.TXT",delimiter="\t",encoding='ISO-8859-1')
    info_facs1 = pd.read_csv("/home/ajay/Downloads/Outgoing/info-out_PUT_in_FACS.TXT", delimiter="|")
