...
class Harrison:
    def Harrison(self,df,inf, writer):
        try:
            ...
            inf3.drop(inf3[((inf3['Issue Detected'] == 'Balance Match') | (inf3['Issue Detected'] == 'Balance Mismatch'))].index)
            # print(df7.to_string())
            ...
            df7 = df7.drop(df7[ ~(df7['Phase'] == 20)].index)
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/harison2.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df_facs1 = pd.read_csv("/home/ajay/Downloads/Harrison_Incoming_file/HA4_MVA_HOSP_PHY_RECON_060321_57594.TXT",delimiter="\t")
    info_facs1 = pd.read_csv("/home/ajay/Downloads/Harrison_Incoming_file/info-out_MVA NOT_in_FACS.TXT",delimiter="|")
