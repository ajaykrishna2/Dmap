...
class read_input_for_exception:
    ...
    def st_vincent_read(self):
      try:
        ...
        for i in filtered_list:
            if 'Exec_St_Vincent' in i and str(read_input_for_exception.year) in i and read_input_for_exception.month_name in i:
        ...
        print("Error in processing st_vincent_dataframe")
    ...
    def book_to_facs_read(self):
      try:
          ...
          data = obj['Body'].read()
          book_to_facs = pd.read_excel(io.BytesIO(data),sheet_name="STV")
          return book_to_facs
