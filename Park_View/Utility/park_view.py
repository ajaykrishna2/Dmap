...
def park_view(parkview_client_statement):
        ...
        try:
            ...
            save_statement_to_output_folder.send_statement(Parkview, "104999 Park_View", "Park_View_Statement","Park_View")
        except Exception as e:
            logging.exception("error in splitting data in Park_View")
