...
class womenshospital_reconcilation_report:
    def Womenshospital(self,df,inf):
        try:
            ...
            df = df[['Issue Detected', 'FACS #', 'EPIC #', 'Client ID', 'First Name', 'Last Name', 'Disposition', 'Phase','List Date', 
                     'Med-1 Balance', 'Recon file (EPIC) balance', 'Amount Cancelled', 'Last Payment Date','Cancel Code',
            ...
            inf2 = inf.rename(columns={'Issue Deteched': 'Issue Detected', 'FACS Acct': 'FACS #', 'Client REF #': 'EPIC #',
                              ...
                              'Last Pay DTE': 'Last Payment Date','Disp Chang DTE': 'Last Payment Date.1','Unnamed: 16':'Epic Type'}, 
                              inplace=False)
            ...
            logging.exception("Error in processing womens_hospital recon file")
