...
class Harrison:
    def Harrison(self,df,inf, writer):
        try:
            ...
            df26.to_excel(writer, index=False, sheet_name='Balance Mismatch')
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/harison11.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df_facs1 = pd.read_csv("/home/ajay/Downloads/Harrison_Incoming_file/HA2_EO_HOSP_PHY_RECON_060321_57559.TXT",delimiter="\t")
    info_facs1 = pd.read_csv("/home/ajay/Downloads/Harrison_Incoming_file/info-out_EO NOT_in_FACS.TXT",delimiter="|")
