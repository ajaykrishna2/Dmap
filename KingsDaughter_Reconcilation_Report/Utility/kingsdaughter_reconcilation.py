...
class kingsdaughter_reconcilation_report:
    def Kingsdaughter(self,df):
        try:
            ...
            save_file.send_statement(df5, 'Closed in FACS','Rec_Kings_Daughter','Kingsdaughter')
            save_file.send_statement(df6, 'FACS not RECON','Rec_Kings_Daughter','Kingsdaughter')
            save_file.send_statement(df7, 'RECON not FACS', 'Rec_Kings_Daughter', 'Kingsdaughter')
            save_file.send_statement(df10, 'Balance Mismatch','Rec_Kings_Daughter','Kingsdaughter')
            save_file.send_statement(df11, 'Balance Match','Rec_Kings_Daughter','Kingsdaughter')
        
        except Exception as e:
            logging.exception("Error in processing kingsdaughter recon file")
