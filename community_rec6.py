...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/COMMUNITY_EPIC_RECON_111521_56445_.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df = pd.read_csv("/home/ajay/Downloads/EnableFiles/Community/Outgoing/COMMUNITY_EPIC_RECON_111521_56445.TXT",delimiter="\t")
    print(df)
    df_facs1 = df
