...
class Communityhospital:
    def communityhospital(self,df, writer):
        try:
            ...
            dfP = df2[df2['Phase MisMatch'] == "Phase Mismatch."]
            df2.drop(dfP.index,inplace=True)
            ...
            dfP.to_excel(writer, index=False, sheet_name='Phase MisMatch')
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/COMMUNITY_EPIC_RECON_MED1_111621_29037_.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df = pd.read_csv("/home/ajay/Downloads/EnableFiles/Community/Outgoing/COMMUNITY_EPIC_RECON_MED1_111621_29037.TXT",delimiter="\t")
    print(df)
    df_facs1 = df
