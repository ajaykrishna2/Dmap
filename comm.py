...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/COMMUNITY_EPIC_LGL_RECON_111521_60406.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    # mylist=[]
    # ChunkSize = 10
    ...
    #     mylist.append(chunk)
    # print(len(mylist))
    df = pd.read_csv('/home/ajay/Downloads/EnableFiles/Community/Outgoing/COMMUNITY_EPIC_LGL_RECON_111521_60406.TXT', sep='\t',names=['Issue Detected', 'FACS #', 'EPIC #', 'Client ID', 'First Name', 'Last Name', 'Disposition',
                            'Phase', 'List Date', 'Med-1 Balance', 'Amount Cancelled', 'Recon file (EPIC) balance',
                            'Last Payment Date', 'Cancel Code', 'Cancel Date', 'Cancel Description', 'Legal Flag',
                            'samp'], skiprows=1)
