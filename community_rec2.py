...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/COMMUNITY_EPIC_RECON_MED1_041221_67031.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df = pd.read_csv("/home/ajay/Downloads/COMMUNITY_EPIC_RECON_MED1_041221_67031.TXT",delimiter="\t")
    print(df)
    df_facs1 = df
