...
def Exception_report(writer):
    ...
    try:
        ...
        df['Client #']=df['Client #'].str.replace('nan', '132E55')
        ...
        d2 = book_to_facs.groupby(['Client#']).agg({'PRN': 'sum','O/P Amt': 'sum'})
        # d2.loc=d2
        ...
        # print(d2.info())
        # print(d1['Total'])
        d1['book_to_facs_PRN']=d2['PRN']
        d1['book_to_facs_O/P_Amt'] = d2['O/P Amt']
        ...
        df3=df2[['Clients Acct #', 'Client #', 'Pmt Amt Applied', 'Pd to Agency', 'Pd to You', 'Due Agency', 'Due You','Total' ,'PRN', 'O/P Amt','Int','Atty','Misc','CC','PJI','Total Pay']]
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/deconess_hospital_exception_report2.xlsx', engine='xlsxwriter')
