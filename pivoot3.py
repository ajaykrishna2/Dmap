...
med1_df = df.loc[(df['CLIENT'].isin(['201AWP' , '202AWP'])),["NAME","CLIENT","Year","Month","NUM_ACCTS_LISTED","LISTED","COLLECTED","ADJUSTED","RECALLED","VOL_CANCELLED","FEES","AVG AGE AT LIST","Inventory Remaining","Unadjusted %","adjusted %"]]
...
table3.to_excel('CBS Early Out.xlsx',sheet_name='MED-1 Collections')