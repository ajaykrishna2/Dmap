...
def Riverview(df, writer):
    try:
        ...
        table6 = table3.style.apply(highlight_col1, axis=None).set_table_styles(styles)
        ...
        table7 = table4.style.apply(highlight_col1, axis=None).set_table_styles(styles)
        #
        ...
        table8 = table5.style.apply(highlight_col1, axis=None).set_table_styles(styles)
        # details
