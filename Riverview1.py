...
def Riverview(facs,writer):
    try:
        ...
        format_dict = {"Amt Listed": '${0:,.0f}'}
        Sheet2.style.format(format_dict)
        ...
        med1_df1 = df.loc[(df['CLIENT'].isin(['201AWP', '202AWP'])), Column1]
        ...
        # Sheet4["Inventory Remaining"] = Sheet4["Inventory Remaining"].apply(lambda x: round(x, 0))
        ...
        # Sheet6["# of Accts Listed"] =int(Sheet6["# of Accts Listed"])
        # Sheet6["# of Accts Listed"]=Sheet6["# of Accts Listed"]
...
if __name__ == "__main__":
    ...
    writer = pd.ExcelWriter('/home/ajay/pDs_Riverview12.xlsx', engine='openpyxl')
