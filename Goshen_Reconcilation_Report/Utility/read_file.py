    ...
    def collect_and_preprocess_goshen_data(cls):
        try:
            ...
            for i in filtered_list:
              if 'Rec_Goshen_Hospital' in i and str(cls.year) in i and cls.month_name in i:
                ...
                data = obj['Body'].read()
                goshen_reconcilation_statement = pd.read_table(io.BytesIO(data),sep="\t",index_col=False, encoding="ISO-8859-1")
            return goshen_reconcilation_statement

        except Exception as e:
            logging.exception("Error in reading goshen recon file")
