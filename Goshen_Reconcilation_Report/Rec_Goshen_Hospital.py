...
class Goshen_reconcilation:
    ...
    logging.basicConfig(filename=local_output_directory+'Goshen_reconcilation.log',
    ...
    reconcilation = goshen_reconcilation_report()
    reconcilation.Goshen(reconcilation_read)
