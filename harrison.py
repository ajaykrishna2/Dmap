...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/HA1_BD_HOSP_PHY_RECON_060321_57567.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df_facs1 = pd.read_csv("/home/ajay/Downloads/HA1_BD_HOSP_PHY_RECON_060321_57567.TXT",delimiter="\t")
    info_facs1 = pd.read_csv("/home/ajay/Downloads/info-out_BD NOT_in_FACS.TXT",delimiter="|")
