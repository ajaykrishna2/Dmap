...
def union_county_hospital(union_client_statement):
    try:
        # creating MED1OS tab
        MED1OS=union_client_statement.loc[
                union_client_statement['Clients Acct #'].astype(str).str.contains("42000",regex=True)&
            (union_client_statement['Client #'].isin( ['127I55', '127MDM', '127R25', '127R55', '127ECA','127REC'] ))
        ]

        save_statement_to_output_folder.send_statement( MED1OS, "MED1 OS", "union_county_hospital", "Deaconess")
    ...
    try:
        ...
        save_statement_to_output_folder.send_statement( MED1ACL, "MED1 ACL", "union_county_hospital", "Deaconess")
    except Exception as e:
    ...
    try:
        ...
        save_statement_to_output_folder.send_statement( CBSOS, "CBS OS", "union_county_hospital", "Deaconess")
    except Exception as e:
    ...
    try:
        ...
        save_statement_to_output_folder.send_statement( CBSACL, "CBS ACL", "union_county_hospital", "Deaconess")
    except Exception as e:
