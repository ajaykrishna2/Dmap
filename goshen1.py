...
class goshen:
    def Goshen(self,df, writer):
        try:
            ...
            df['Date'] = inf6_dt.dt.strftime('%d-%m-%Y')
            print(df['Date'])
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/Goshen-N_Recon_100621_8797.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df_facs1 = pd.read_csv("/home/ajay/Downloads/Goshen-N_Recon_100621_8797.TXT",delimiter="\t")
