...
import configparser
import os
from g_ads.gads_process.gdate import *
from g_ads.gads_process.g_ads import *
...
body = 'Extracted the google ads data of '+str(time_date()[0])+' and insertion completed to the database successfully on :'+str(time_date()[1])
