...
class Communityhospital:
    def communityhospital(self,df, writer):
        try:
            ...
            dfP = df[df['Phase MisMatch'] == "Phase Mismatch."]
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/COMMUNITY_EPIC_RECON_MED1_REID_041221_61837.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df = pd.read_csv("/home/ajay/Downloads/COMMUNITY_EPIC_RECON_MED1_REID_041221_61837.TXT",delimiter="\t")
    print(df)
    df_facs1 = df
