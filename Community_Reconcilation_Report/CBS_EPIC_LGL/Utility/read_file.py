...
class read:
    ...
    def collect_and_preprocess_comm_cbs_epic_lgl_data(self):
        try:
            ...
            for i in filtered_list:
              if 'Rec_Community' in i and str(read.year) in i and read.month_name in i and 'CBS_EPIC_LGL' in i:
                ...
                data = obj['Body'].read()
                community_reconcilation_statement = pd.read_table(io.BytesIO(data),sep="\t",index_col=False, encoding="ISO-8859-1")
            return community_reconcilation_statement
