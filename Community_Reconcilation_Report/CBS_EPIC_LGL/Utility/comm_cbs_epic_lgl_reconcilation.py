...
class comm_cbs_epic_lgl_reconcilation_report:
    def Comm_cbs_epic_lgl(self,df):
        try:
            ...
            print(save_file)
            save_file.send_statement(df4, 'Closed in FACS','CBS_EPIC_LGL','Rec_Community')
            save_file.send_statement(df6, 'FACS not RECON','CBS_EPIC_LGL','Rec_Community')
            save_file.send_statement(df5, 'RECON not FACS','CBS_EPIC_LGL','Rec_Community')
            save_file.send_statement(df10, 'Balance Mismatch','CBS_EPIC_LGL','Rec_Community')
            save_file.send_statement(df13, 'Balance Match','CBS_EPIC_LGL','Rec_Community')
            save_file.send_statement(ad, 'Adjustments','CBS_EPIC_LGL','Rec_Community')
