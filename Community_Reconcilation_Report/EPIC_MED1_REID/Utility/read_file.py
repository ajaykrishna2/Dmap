...
class read:
    ...
    def collect_and_preprocess_comm_epic_recon_med1_reid_data(self):
        try:
            ...
            for i in filtered_list:
              if 'Rec_Community' in i and str(read.year) in i and read.month_name in i and 'EPIC_MED1_REID' in i:
                ...
                data = obj['Body'].read()
                comm_epic_recon_med1_reid_reconcilation_statement = pd.read_table(io.BytesIO(data),sep="\t",index_col=False, encoding="ISO-8859-1")
            return comm_epic_recon_med1_reid_reconcilation_statement
