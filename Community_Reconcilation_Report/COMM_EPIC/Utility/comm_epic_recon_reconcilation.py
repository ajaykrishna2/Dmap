...
class comm_epic_recon_reconcilation_report:
    def Comm_epic_recon(self,df):
        try:
            ...
            save_file.send_statement(df4, 'Closed in FACS','COMM_EPIC','Rec_Community')
            save_file.send_statement(df6, 'FACS not RECON','COMM_EPIC','Rec_Community')
            save_file.send_statement(df5, 'RECON not FACS','COMM_EPIC','Rec_Community')
            save_file.send_statement(df10, 'Balance Mismatch','COMM_EPIC','Rec_Community')
            save_file.send_statement(df13, 'Balance Match','COMM_EPIC','Rec_Community')
            save_file.send_statement(ad, 'Adjustments','COMM_EPIC','Rec_Community')
