...
class comm_epic_recon_med1_reconcilation_report:
    def Comm_epic_recon_med1(self,df):
        try:
            ...
            save_file.send_statement(df4, 'Closed in FACS','EPIC_RECON_MED1','Rec_Community')
            save_file.send_statement(df6, 'FACS not RECON','EPIC_RECON_MED1','Rec_Community')
            save_file.send_statement(df5, 'RECON not FACS','EPIC_RECON_MED1','Rec_Community')
            save_file.send_statement(df10, 'Balance Mismatch','EPIC_RECON_MED1','Rec_Community')
            save_file.send_statement(df13, 'Balance Match','EPIC_RECON_MED1','Rec_Community')
            save_file.send_statement(ad, 'Adjustments','EPIC_RECON_MED1','Rec_Community')
