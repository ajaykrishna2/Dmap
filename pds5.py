...
def Riverview(facs,writer):
    try:
        ...
        med1_df = df.loc[(df['CLIENT'].isin(['201ECA', '202ECA'])), ["NAME", "CLIENT", "Year", "Month", "NUM_ACCTS_LISTED", "LISTED",
        ...
        med1_df.columns = ["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered",
                           ...
                           "Unadjusted %", "adjusted %"]
        med1_df.stb.freq(["Unadjusted %"],thresh=.2,style=True)
        med1_df["Inventory Remaining"] = med1_df["Inventory Remaining"].astype(int)
        med1_pivot = pd.pivot_table(med1_df, index=["NAME", "CLIENT", "Year", "Month"])
        ...
        d1 = med1_pivot[
            ["NAME", "CLIENT", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments", "RECALLED",
             "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %", "adjusted %"]].groupby(["NAME", "CLIENT"], as_index=False).sum().stb.subtotal()
        d2= med1_pivot[
            ["NAME", "CLIENT", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments", "RECALLED",
             "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %", "adjusted %"]].groupby(
            ["NAME", "CLIENT"], as_index=False).mean()
        ...
        df1 = cff[cff.columns.difference(["AVG AGE AT LIST_x", "Unadjusted %_x", "adjusted %_x", "# of Accts Listed_y", "Amt Listed_y", "Recovered_y", "Adjustments_y",
        ...
        c1 = Sheet1[["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments",
                      "RECALLED", "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %",
                      "adjusted %"]].groupby(["NAME", "CLIENT", "Year"], as_index=False).sum()
        c2 = Sheet1[ ["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments",
                      "RECALLED", "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %",
                      "adjusted %"]].groupby(["NAME", "CLIENT", "Year"], as_index=False).mean()
        dff = pd.merge(c1, c2,on=["CLIENT", "Year"])
        df2 = dff[dff.columns.difference([ "AVG AGE AT LIST_x", "Unadjusted %_x","adjusted %_x","NAME_y","# of Accts Listed_y", "Amt Listed_y", "Recovered_y", "Adjustments_y",
                      "RECALLED_y", "Returned_y", "FEES_y",  "Inventory Remaining_y"])]
        df2.columns=[ "# of Accts Listed","AVG AGE AT LIST","Adjustments", "Amt Listed", "CLIENT", "FEES","Inventory Remaining","NAME","RECALLED","Recovered", "Returned",   "Unadjusted %", "Year","adjusted %"]
        ...
        Sheet2 = Sheet2[["# of Accts Listed", "Amt Listed", "Recovered", "Unadjusted %", "Adjustments", "RECALLED","Returned", "adjusted %", "Inventory Remaining", "FEES", "AVG AGE AT LIST"]].apply(lambda x: round(x, 2))
        ...
        table3.set_index(["NAME", "CLIENT", "Year", "Month"], inplace=True)
        ...
        med1_pivot1 = pd.pivot_table(med1_df1, index=["NAME", "CLIENT", "Year", "Month"])
        ...
        d3 = med1_pivot1[
            ["NAME", "CLIENT", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments", "RECALLED",
             "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %", "adjusted %"]].groupby(
            ["NAME", "CLIENT"], as_index=False).sum().stb.subtotal()
        d4 = med1_pivot1[
            ["NAME", "CLIENT", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments", "RECALLED",
             "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %", "adjusted %"]].groupby(
            ["NAME", "CLIENT"], as_index=False).mean()
        ...
        df3 = cff1[cff1.columns.difference(
            ["AVG AGE AT LIST_x", "Unadjusted %_x", "adjusted %_x", "# of Accts Listed_y", "Amt Listed_y",
        ...
        c3 = Sheet3[["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments",
                     "RECALLED", "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %",
                     "adjusted %"]].groupby(["NAME", "CLIENT", "Year"], as_index=False).sum()
        c4 = Sheet3[["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments",
                     "RECALLED", "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %",
                     "adjusted %"]].groupby(["NAME", "CLIENT", "Year"], as_index=False).mean()
        dff1 = pd.merge(c3, c4, on=["CLIENT", "Year"])
        df4 = dff1[dff1.columns.difference(
            ["AVG AGE AT LIST_x", "Unadjusted %_x", "adjusted %_x", "NAME_y", "# of Accts Listed_y", "Amt Listed_y",
             "Recovered_y", "Adjustments_y",
             "RECALLED_y", "Returned_y", "FEES_y", "Inventory Remaining_y"])]
        ...
        Sheet4.set_index(["NAME", "CLIENT", "Year", "Month"], inplace=True)
        Sheet4 = Sheet4.sort_values(["NAME", "CLIENT", "Year", "Month"])
        column_order = ["# of Accts Listed", "Amt Listed", "Recovered", "Unadjusted %", "Adjustments", "RECALLED",
                        "Returned", "adjusted %", "Inventory Remaining", "FEES", "AVG AGE AT LIST"]
        Sheet4 = Sheet4[
        ...
        table4.set_index(["NAME", "CLIENT", "Year", "Month"], inplace=True)
        #
        # # for CBS Work Comp_Accident
        med1_df2 = df.loc[
            (df['CLIENT'].isin(['201ERP', '201WCP', '202ERP', '202WCP'])), ["NAME", "CLIENT", "Year", "Month",
                                                                            "NUM_ACCTS_LISTED", "LISTED",
                                                                            "COLLECTED", "ADJUSTED", "RECALLED",
                                                                            "VOL_CANCELLED", "FEES",
                                                                            "AVG AGE AT LIST", "Inventory Remaining",
                                                                            "Unadjusted %",
                                                                            "adjusted %"]]
        ...
        c5 = Sheet5[["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments",
                     "RECALLED", "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %",
                     "adjusted %"]].groupby(["NAME", "CLIENT", "Year"], as_index=False).sum()
        c6 = Sheet5[["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Adjustments",
                     "RECALLED", "Returned", "FEES", "AVG AGE AT LIST", "Inventory Remaining", "Unadjusted %",
                     "adjusted %"]].groupby(["NAME", "CLIENT", "Year"], as_index=False).mean()
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/PDS_Riverview.xlsx', engine='openpyxl')
