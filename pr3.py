...
def Riverview(df, writer):
    try:
        ...
        table6 = tab1[["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Unadjusted %","Adjustments","RECALLED", "Returned", "Adjusted %", "Inventory Remaining", "FEES", 'rank',"AVG AGE AT LIST"]].style.apply(highlight_col1, axis=None).set_properties(**{'text-align': 'right'}).set_table_styles(styles)
        ...
        # h=["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Unadjusted %","Adjustments","RECALLED", "Returned", "Adjusted %", "Inventory Remaining", "FEES", "AVG AGE AT LIST"]
        table6.to_excel(writer, index=False, sheet_name='MED-1 Collections',cols=["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Unadjusted %","Adjustments","RECALLED", "Returned", "Adjusted %", "Inventory Remaining", "FEES", "AVG AGE AT LIST"])
...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/Riverview Collections Report Feb 2021.xlsx', engine='openpyxl' )
    book = load_workbook('/home/ajay/Downloads/Jessica Sims Sample Report_Riverview Collections Report FEB 2021 (1).xlsx')
    writer.book = book
    df_facs1 = pd.read_excel(writer.book, 'Details')
    Riverview(df_facs1, writer)
    writer.save()

# ["NAME", "CLIENT", "Year", "Month", "# of Accts Listed", "Amt Listed", "Recovered", "Unadjusted %","Adjustments","RECALLED", "Returned", "Adjusted %", "Inventory Remaining", "FEES", "AVG AGE AT LIST"]
