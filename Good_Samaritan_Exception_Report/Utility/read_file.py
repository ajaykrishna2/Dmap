    ...
    def good_sam_read(self):
      try:
        ...
        for i in filtered_list:
            if 'Exec_Good_Samaritan' in i and str(read_input_for_exception.year) in i and read_input_for_exception.month_name in i:
        ...
        print("Error in reading good samaritan statement")
