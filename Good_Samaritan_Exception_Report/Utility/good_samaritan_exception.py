...
class good_sam_exception:
    ...
    def book_to_facs_preprocess(self,book_to_facs):
        try:
            ...
            book_to_facs = book_to_facs.loc[book_to_facs['Client#'].isin(['238E25', '238INS', '238SPP', '238ERP', '238AWP', '237E25', '237INS',\
            '237SPP', '237ERP', '237AWP','238I55', '238R25', '238R55', '238REC', '238SEC', '239BD', '238ECA', '237I55', '237R25', '237R55',\
            '237REC', '237SEC', '237ECA'])]
    ...
    def billing_statement_preprocess(self,good_samaritan):
        try:  
            ...
            dataframe = good_samaritan[["Client #","Client's Acct#","Pmt Amt","Pd to Agency","PD to you","Due Agency","Due You","Over Paid"]]
            df1 = dataframe[["Client #","Pmt Amt","PD to you",'Pd to Agency',"Due Agency","Due You","Over Paid"]].groupby(["Client #"]).sum()
    ...
    def Amount_Validation(self,good_samaritan,book_to_facs):
        try:
            ...
            save_file.send_statement(client_id_level12,'Amount Validation','Exec_Good_Samaritan','output/Good_Samaritan')
    ...
    def Exception_report(self,good_samaritan,book_to_facs):
            try:
                ...
                save_file.send_statement(exception11,'Balance Mismatch','Exec_Good_Samaritan','output/Good_Samaritan')
                ...
                save_file.send_statement(statement_exception,'Statement_Missing_Records','Exec_Good_Samaritan','output/Good_Samaritan')
                ...
                save_file.send_statement(book_to_facs_exception,'BookToFacs_Missing_Records','Exec_Good_Samaritan','output/Good_Samaritan')
                ...
                save_file.send_statement(statement_dup,'Statement Miscellaneous','Exec_Good_Samaritan','output/Good_Samaritan')
                ...
                save_file.send_statement(booktofacs_dup,'Book To Facs Miscellaneous','Exec_Good_Samaritan','output/Good_Samaritan')
            except Exception as e:
                print("Error in creating exception report for good samaritan hospital")
