...
class st_vicent_non_facs:
    ...
    def splitting_vincent_dunn_statement(vincent_statement):
        try:
            # creating dunn tab
            ...
            save_statement_to_output_folder.send_statement(dunn_statement, "DUNN_data", "DUNN_statement","St_Vincent_Dunn")
        except Exception as e:
