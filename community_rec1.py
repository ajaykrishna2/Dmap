...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/COMMUNITY_EPIC_RECON_041221_61206.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df = pd.read_csv("/home/ajay/Downloads/COMMUNITY_EPIC_RECON_041221_61206.TXT",delimiter="\t")
    print(df)
    df_facs1 = df
