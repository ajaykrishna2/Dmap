...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/RVH_Inven_RECON_120121_4024.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df_facs1 = pd.read_csv("/home/ajay/Downloads/RVH_Inven_RECON_120121_4024.TXT",delimiter="\t")
