    ...
    def deaconess_read(self):
      try:
        ...
        for i in filtered_list:
            if 'Exec_Deaconess' in i and str(read_input_for_exception.year) in i and read_input_for_exception.month_name in i:
        ...
        print("Error in processing deaconess_dataframe")
