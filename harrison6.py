...
if __name__ == "__main__":
    writer = pd.ExcelWriter('/home/ajay/harison21.xlsx', engine='xlsxwriter',options={'strings_to_numbers':True} )
    df_facs1 = pd.read_csv("/home/ajay/Downloads/HA4_MVA_HOSP_PHY_RECON_060321_57594.TXT",delimiter="\t")
    info_facs1 = pd.read_csv("/home/ajay/Downloads/info-out_MVA NOT_in_FACS.TXT",delimiter="|")
